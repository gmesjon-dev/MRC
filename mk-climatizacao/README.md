...
- `assets/img/` — logo redonda, hero desktop/mobile, serviços, galeria, parceiros e marcas
...
4. **Logo HNT**: é um wordmark provisório — substitua `assets/img/partners/hnt.svg` pelo arquivo oficial.
5. Horários de atendimento no rodapé e área atendida: confirmar com o cliente.
